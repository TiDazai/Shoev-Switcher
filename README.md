...
[Скачать Shoev Switcher для macOS](https://github.com/TiDazai/Shoev-Switcher/releases/download/v0.3.0-alpha/Shoev-Switcher.dmg)
...
- флаг текущей раскладки рядом с курсором над полями ввода;
